...
def test_or(driver, file_path="/home/sathish/Satheesh/satz/2025/stagingsample/samplePDFFile.pdf"):
...
#OR number
       safe_send_keys(driver, (By.XPATH, "(//input[@type='text'])[3]"), "WQITRE3456")
#ForeginmBeneficery name
       safe_click(driver, "(//input[@id='myDropdown'])[2]")
       safe_click(driver, "(//li[@class='li-dropdown ng-star-inserted'])[1]")
#report date
       safe_send_keys(driver, (By.XPATH, "(//input[@type='date'])[4]"), "15/06/2025")
#report ratting
       safe_send_keys(driver, (By.XPATH, "(//input[@type='text'])[5]"), "20")
#submit
       safe_click(driver, "(//button[@id='ImportOpinionreport'])[1]")
