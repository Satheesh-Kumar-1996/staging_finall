...
def test_ABC(driver, file_path="/home/sathish/Satheesh/satz/2025/stagingsample/samplePDFFile.pdf"):
    ...
    try:
        ...
        safe_click(driver, "(//h6[normalize-space()='Credit Notes'])[1]")
        ...
        #credit note
        safe_send_keys(driver, (By.XPATH, "(//input[@type='textbox'])[1]"), "3000000")
        #Submit
        safe_click(driver, "(//button[@id='CreditNoteImport'])[1]")
