...
def test_BLR(driver, file_path="/home/sathish/Satheesh/satz/2025/stagingsample/samplePDFFile.pdf"):
    test_name = inspect.currentframe().f_code.co_name
    timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    output_dir = r"/home/sathish/PythonProject/exim/videos/"
    ...
    try:
        ...
        safe_send_keys(driver, (By.XPATH, "(//input[@aria-autocomplete='list'])[1]"), "ACC" + Keys.ENTER)
        #Bill ref date
        safe_send_keys(driver, (By.XPATH, "(//input[@type='date'])[3]"), "12/06/2025")
        #Bill Ref Number
        safe_send_keys(driver, (By.XPATH, "(//input[@type='text'])[4]"), "WQER2134")
        #Bill Ref Amount
        safe_send_keys(driver, (By.XPATH, "(//input[@type='textbox'])[1]"), "1200")
        #submit
        safe_click(driver, "(//button[@id='importbilllodgementreferencenumberadvicecopy'])[1]")
